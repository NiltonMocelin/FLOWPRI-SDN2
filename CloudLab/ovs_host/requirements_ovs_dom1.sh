...
sudo ip route add 172.16.1.10 dev $INTC1 metric 1050

# rota para host 
sudo ip route add 172.16.1.30 dev $INTH1 metric 1050

# rota para dominios maiores
sudo ip route add 172.16.2.0 dev $INTSMA metric 1050
...
# sudo ip route add 172.16.2.30 dev $INTSME metric 1050
